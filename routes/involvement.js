...
router.get('/philanthropy',
	...
	res.render('pages/basicText', { 
		...
		content: [
			{parallax: {rem:'15', url:'/res/plp/graphics/philamb_flag.png'}, hero : {title:'Philanthropy', content:`Below is a non-exhaustive list of the philanthropies that Phi Lamb supports. If you would like to know more, use the buttons provided to visit the oraganization's website.`}},
